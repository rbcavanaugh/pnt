test_that("score uploaded test 35 excel", { 
  ...
  app$uploadFile(file2 = here::here("tests", "testthat", "files", "pnt-cat-35.xlsx"))
  ...
  # TESTS
  #########################################################
  uploaded_file = readxl::read_xlsx(here::here("tests", "testthat", "files", "pnt-cat-35.xlsx"), na = "NA")
